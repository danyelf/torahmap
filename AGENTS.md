...
Danyel has looked at it and agreed it's ready to close. Run `npm run test:layout` first, and attach
or link the contact sheet it writes (`layout-report/index.html`) for the states the change touches.
