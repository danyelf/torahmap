...
Identified in test suite audit (torahmap-8xb). These files appear to be from an earlier test structure that was superseded by the organized `unit/` directory structure.
